...
@Composable
fun EliminarOEditarDoctor(modifier: Modifier = Modifier) {
    Box(
        modifier = modifier
        ...
        Text(
            ...
            modifier = Modifier
                ...
                .rotate(degrees = 0.49f))
        Text(
            text = "Eliminar o Editar Veterinario/a ",
            color = Color(0xff49200c),
            style = TextStyle(
                fontSize = 20.sp,
                fontWeight = FontWeight.Bold),
...
@Composable
private fun EliminarOEditarDoctorPreview() {
    EliminarOEditarDoctor(Modifier)
}