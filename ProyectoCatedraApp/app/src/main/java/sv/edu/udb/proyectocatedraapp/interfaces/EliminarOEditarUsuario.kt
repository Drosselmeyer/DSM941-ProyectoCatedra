...
@Composable
fun EliminarOEditarUsuario(modifier: Modifier = Modifier) {
    Box(
        modifier = modifier
        ...
        Text(
            ...
            modifier = Modifier
                ...
                .rotate(degrees = 0.49f))
        Text(
            text = "Parentesco de la Mascosta\n\n",
            color = Color(0xffbe7938),
            style = TextStyle(
                fontSize = 18.sp,
                fontWeight = FontWeight.Bold),
        ...
        Text(
            ...
            modifier = Modifier
                ...
                .rotate(degrees = 0.49f))
        Text(
            text = "Eliminar o Editar Usuario ",
            color = Color(0xff49200c),
            style = TextStyle(
                fontSize = 20.sp,
                fontWeight = FontWeight.Bold),
...
@Composable
private fun EliminarOEditarUsuarioPreview() {
    EliminarOEditarUsuario(Modifier)
}